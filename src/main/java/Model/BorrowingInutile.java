...
public class BorrowingInutile {
     ...
     * @param returnDate
     */
    public BorrowingInutile(Document document, MemberInutile member, Date borrowingDate, Date returnDate, Boolean status){
    ...
    public MemberInutile getMember() {
        return member;
    }
    ...
    public void setMember(MemberInutile member) {
        this.member = member;
    }
